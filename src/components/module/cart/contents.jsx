...
export default function CartContent() {
  ...
  const debouncedFetch = useCallback(
    debounce((val) => getSuggestionAddress(val), 500),
    []
  );
        ...
        >
          <Breadcrumb
            items={[
              ...
              {
                title: (
                  <span style={{ textDecoration: "underline" }}>MY CART</span>
                ),
              },
            ]}
          />
      ...
      {!isMobile ? (
        <>
          <LoginStandard
            ...
            loading={isLoading}
          />
          <ForgotStandard isOpen={modalForgot} setIsOpen={setModalForgot} />
          <VerifyStandard isOpen={modalOtp} setIsOpen={setModalOtp} />
          <ResetStandard isOpen={modalReset} setIsOpen={setModalReset} />
          <SignupStandard isOpen={modalSignup} setIsOpen={setModalSignup} />
        </>
      ) : (
        <>
          <LoginMobile
            ...
            loading={isLoading}
          />
          <ForgotMobile isOpen={modalForgot} setIsOpen={setModalForgot} />
          <VerifyMobile isOpen={modalOtp} setIsOpen={setModalOtp} />
          <ResetMobile isOpen={modalReset} setIsOpen={setModalReset} />
          <SignupMobile isOpen={modalSignup} setIsOpen={setModalSignup} />
        </>
      )}
    </>
  );
