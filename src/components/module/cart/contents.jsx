...
import { Breadcrumb, Button, Col, ConfigProvider, DatePicker, Input, message, Row, Select, Card } from 'antd'
import { useOrder } from '../../../context/OrderContext';
import { IconBuildingStore, IconCalendarWeek, IconChevronDown, IconChevronRight, IconClock, IconMapPin, IconNotes, IconPencilMinus, IconSearch, IconToolsKitchen2, IconXboxXFilled, IconCircleMinus, IconCirclePlusFilled, IconTicket } from '@tabler/icons-react';
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <img src='/assets-v2/banner/little-3.png' width={"100%"} />
                </div>
                <ConfigProvider
                    theme={{
                        token: {
                ...
                >
                    <Breadcrumb 
                        items={[
                            ...
                            {
                              title: <span style={{ textDecoration: 'underline' }}>MY CART</span>
                            },
                        ]}
                    />
                    <Row
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Make sure all the order is right
                            </div>
                        </Col>
                        <Col
                            span={setSize(12, 12, 24)}
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                className='text-[#393939] font-bold lg:text-[14px] md:text-[12px] text-[11px]'
                                            >
                                                ORDER LIST
                                            </div>
                                        </Col>
                                        {
                                            qtyTemp < 15 && (
                                                ...
                                                >
                                                    <div
                                                        className='bg-[#FFD39A] font-[Noto Sans KR] w-full flex justify-center items-center w-fit m-auto lg:text-[16px] lg:py-2 lg:px-10 md:text-[12px] md:py-1.5 md:px-8 text-[9px] py-1 px-3 lg:rounded-[8px] md:rounded-[8px] rounded-[4px]' 
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <Row>
                                                                    ...
                                                                    >
                                                                        <div
                                                                            className='lg:text-[12px] md:text-[10px] text-[8px] font-semibold'
                                                                        >
                                                                            {value.name}
                                                                        </div>
                                                                        {
                                                                            (value.variant && value.size) && (
                                                                                <div
                                                                                    className='text-[9px] lg:text-[10px] md:text-[9px]'
                                                                                >
                                                                        ...
                                                                        }
                                                                        {
                                                                            isStandard && (
                                                                                <div
                                                                                    className='lg:text-[12px] md:text-[10px] text-[10px] font-semibold font-[Montserrat] mt-1.5'
                                                                                >
                                                                        ...
                                                                        !isStandard && (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        <div
                                                                                            className='lg:text-[12px] md:text-[10px] text-[10px] font-semibold'
                                                                                        >
                                                                                            Rp. {value.price ? parseFloat(value.price).toLocaleString() : '-'}
                                                                                        </div>
                                                                                    </Col>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            />
                                            <div
                                                className='text-[#393939] font-semibold lg:text-[14px] md:text-[12px] text-[11px] pl-2.5'
                                            >
                                                VOUCHER
                                            </div>
                                        </Col>
                                    ...
                                    >
                                        ...
                                        >
                                            <Button
                                                ...
                                                disabled={(deliveryFee === 0 || qtyTemp < 15) ? true : false}
                                                onClick={() => onCheckout()}
                                            >
                                                {`Procced Checkout`} <IconChevronRight size={setSize(14, 12, 10)} />
                                            </Button>
                                        </Col>
                                    </Row>
                                </Col>
