...
export default function CompleteComp() {
  ...
  const { token, authUser, resMessage, setResMessage, setSize } = useAuth();
  ...
  let exDate =
    dayjs(orderDetail && orderDetail.pre_order).format(
      "dddd, DD MMM YYYY HH:mm"
    ) +
    "-" +
    dayjs(orderDetail && orderDetail.pre_order)
      .add(1, "hour")
      .format("HH:mm");
          ...
          >
            ...
            <div>
              ...
              <Input
                ...
                readOnly
                value={orderDetail && orderDetail.address_order}
              />
            </div>
          </ConfigProvider>
        </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <span
                    style={{
                      marginTop: 10,
                      backgroundColor: "rgba(232, 54, 0, 0.1)",
                      color: "#E83600",
                      padding: 4,
                    }}
                  >
              ...
              <Button
                ...
                onClick={() => {
                  localStorage.removeItem("resOrder"), navigate("/history");
                }}
              >
                See Order History{" "}
                <IconChevronRight
                  size={setSize(12, 10, 10)}
                  style={{ marginTop: 2 }}
                />
              </Button>
              <Button
                ...
                onClick={() => {
                  localStorage.removeItem("resOrder"), navigate("/");
                }}
              >
                Back To Home
              </Button>
